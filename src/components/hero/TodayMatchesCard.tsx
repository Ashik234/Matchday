...
export function TodayMatchesCard() {
  ...
  return (
    <div className="relative rounded-2xl bg-bg-elev1 border border-white/5 shadow-card p-6 md:p-8 min-h-[480px] flex flex-col">
      ...
      <div className="mt-6 flex-1 flex flex-col gap-3">
        ...
        {!isLoading && !featured && (
          <div className="text-text-dim text-sm">No matches scheduled today.</div>
        )}
